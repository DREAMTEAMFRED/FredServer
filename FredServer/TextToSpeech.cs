    ...
    public class TextToSpeech
    {
        ...
        public async Task TextToWords(string textInput)
        {
            while (true)
            {
                ...
                Authentication auth = new Authentication("https://westus.api.cognitive.microsoft.com/sts/v1.0/issueToken", "de48ef5b15d34f6498fbd831f5d72aec");// Environment.GetEnvironmentVariable("azure_TTS_Key", EnvironmentVariableTarget.User));
                try
                {
